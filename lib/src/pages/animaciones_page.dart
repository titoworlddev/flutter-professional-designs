...
class _CuadradoAnimadoState extends State<CuadradoAnimado> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    opacidad = Tween(begin: 0.1, end: 1.0).animate(
      CurvedAnimation(parent: controller, curve: Interval(0.0, 0.75, curve: Curves.easeOut))
    );
          ...
          child: Transform.translate(
            ...
            child: Transform.rotate(
              ...
              child: Opacity(
                ...
                opacity: (opacidad.value == 1.0) ? opacidadOut.value : opacidad.value, // tambien se puede hacer esto
