...
class __CuadradoAnimadoState extends State<_CuadradoAnimado> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    bordes = Tween(begin: 0.0, end: 50.0).animate(
      CurvedAnimation(parent: controller, curve: Interval(0.0, 0.50, curve: Curves.easeInOut))
    );
    bordes2 = Tween(begin: 0.0, end: 50.0).animate(
      CurvedAnimation(parent: controller, curve: Interval(0.50, 1.0, curve: Curves.easeInOut))
    );
      ...
      builder: (context, child) {
        return Transform.translate(
          offset: Offset(
            ...
            (moverDerecha.value < 100.0) ? moverDerecha.value : moverIzquierda.value, 
            (moverArriba.value > -100.0) ? moverArriba.value : moverAbajo.value, 
          ...
          child: GestureDetector(
            ...
            child: _Rectangulo(borderRadius: BorderRadius.all(Radius.circular(bordes.value - bordes2.value)),)
          )
        );
      },
    );
